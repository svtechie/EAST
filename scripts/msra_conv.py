...
def format(origin_path, target_path):
    for filename in glob.glob(origin_path+'*.gt'):
        ...
        for line in lines:
            ...
            labels.append(','.join(map(str, map(int,rec_rotate(x, y, w, h, theta))))+',###\n')
...
if __name__ == '__main__':
    format('downloads/MSRA-TD500/train/', 'downloads/MSRA-TD500/train/')
    format('downloads/MSRA-TD500/test/', 'downloads/MSRA-TD500/test/')
